...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Build stunning, ATS-friendly resumes with AI-powered suggestions, multiple templates, and instant PDF export.' },
      { property: 'og:title', content: 'AI Resume Builder' },
      { property: 'og:description', content: 'Build stunning, ATS-friendly resumes with AI-powered suggestions.' },
    ],
  }),
  component: Index,
});
